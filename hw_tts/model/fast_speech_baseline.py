...
class FastSpeechBaselineModel(BaseModel):
    """ FastSpeech """

    def __init__(self, model_config):
        super(FastSpeechBaselineModel, self).__init__()
    ...
    def forward(self, text, src_pos, mel_pos=None, mel_max_length=None, duration=None, alpha=1.0, **kwargs):
        ...
        if self.training:
            output, duration_predictor_output = self.length_regulator(x, alpha, duration, mel_max_length)
